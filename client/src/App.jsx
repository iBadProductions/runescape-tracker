    ...
    <div className={"min-h-screen relative " + (flicker ? "flicker" : "") + " bg-white dark:bg-gray-900 text-black dark:text-white p-6"}>
      ...
      {!user ? (
        <div className="flex flex-col items-center gap-2 mb-6">
          <input type="text" placeholder="Username" className="p-2 rounded text-black" onChange={(e) => setUsername(e.target.value)} />
          <input type="password" placeholder="Password" className="p-2 rounded text-black" onChange={(e) => setPassword(e.target.value)} />
